    ...
    <section class="splash team flex--box column acenter jcenter">
      ...
      <?php 
         ...
         $video_field = field_view_field('node', $node, 'field_cover_video', array('label'=>'hidden'));
	       $video_field ? print render($video_field) : '';
         }

         // $host_logo = field_view_field('node', $node, 'field_host_logo', array('label'=>'hidden'));
         // $host_logo ? print render($host_logo) : '';
      ?>
      </div>
    </section>

    <div id="columns" class="columns clearfix flex--box row jcenter astart wrap">
