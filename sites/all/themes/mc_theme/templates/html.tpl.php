...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/sites/all/themes/mc_theme/css/style.css">
	...
	<script src="https://use.typekit.net/zks0isc.js"></script>
...
<body class="<?php print $classes; ?>"<?php print $attributes; ?>>
	<div id="skip-link" class="nocontent">
		<a href="<?php print $skip_link_target; ?>" class="element-invisible element-focusable">
